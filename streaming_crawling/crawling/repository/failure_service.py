...
from crawling.models import CrawlingFailure
from crawling.utils.single_crawling_logger import logger
...
class FailureService:
    ...
    def check_and_handle_failures(song_id: str, target_date=None):
        ...
        try:
            ...
            from crawling.models import CrawlingData, PlatformType
