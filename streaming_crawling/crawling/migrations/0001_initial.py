...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CrawlingPeriod',
            fields=[
                ('id', models.CharField(default=crawling.models.base.generate_uuid, editable=False, max_length=36, primary_key=True, serialize=False)),
